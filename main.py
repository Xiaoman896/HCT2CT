...
def main():
    ...
    parser.add_argument('-inputpath', type=str, default=20, help='input folder path: HCT projections')
    parser.add_argument('-outputpath', type=str, default=3, help='output folder path: virtual CT projections')
