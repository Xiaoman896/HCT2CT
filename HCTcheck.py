...
parser.add_argument('-Nr', type=int, default=3, help='number of rotation')
...
parser.add_argument('-k1', type=int, default=100, help='test projection index: for CT')
...
def main():
    ...
    imprefix = 'proj_'
    imzeropad = 5
    Convertedproj = hct2ct(args.Np, args.Nr, args.linear_step, args.pixel_size, args.inputpath, args.k1, imprefix, imzeropad)
